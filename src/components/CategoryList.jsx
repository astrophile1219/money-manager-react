  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4">
      <div className="flex items-center justify-between mb-4">
        <h4 className="text-lg font-semibold mb-2">Category Sources</h4>
      </div>
              ...
              <div className="flex-1 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button 
                      ...
                      className="text-gray-400 cursor-pointer hover:text-blue-500 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Pencil size={18} />
                  </button>
                </div>
              </div>
